...
function Advantage() {
    ...
    const webScreenMax = () => {
        ...
        document.querySelector(".frame89").style = `
            ...
            width: 46%; height: 400px; min-width: 600px; padding: 40px;
        ...
        document.querySelector(".frame80").style = `
            ...
            width: 46%; height: 400px; min-width: 600px; padding: 30px;
    ...
    const webScreenMin = () => {
        ...
        `;
        document.querySelector('.frame89').style = `
            position: absolute; top: 410px; left: 50px;
        ...
        `;
        document.querySelector('.frame86').style = `
            position: absolute; top: 1230px; left: 50px;
            width: 75%; height: 400px; min-width: 600px; padding: 40px;
            display: flex; flex-direction: column; justify-content: center; flex: 1 0 0;
            border-radius: 0px 60px 60px 60px;
            background: #914D00;
    ...
    return (
        <div className="advantage lab" style={{ width: responsiveWidth }}>
